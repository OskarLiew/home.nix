{ config, ... }: {
  text = with config.colorScheme.colors; ''
    ...
    @define-color destructive_bg_color mix(#${base08}, #${base00},0.3);
    @define-color destructive_fg_color #${base05};
    @define-color success_color #${base0D};
    @define-color success_bg_color #26a269;
    @define-color success_fg_color #${base05};
    @define-color warning_color #${base0A};
    @define-color warning_bg_color #cd9309;
    @define-color warning_fg_color rgba(0, 0, 0, 0.8);
    @define-color error_color #${base0E};
    @define-color error_bg_color mix(#${base08}, #${base00},0.3);
    ...
    @define-color blue_1 #${base08};
    @define-color blue_2 #${base08};
    @define-color blue_3 #${base08};
    @define-color blue_4 #${base08};
    @define-color blue_5 #${base08};
    @define-color green_1 #${base0D};
    @define-color green_2 #${base0D};
    @define-color green_3 #${base0D};
    @define-color green_4 #${base0D};
    ...
    @define-color orange_1 #${base0C};
    @define-color orange_2 #${base0C};
    @define-color orange_3 #${base0C};
    @define-color orange_4 #${base0C};
    @define-color orange_5 #${base0C};
    @define-color red_1 #${base0E};
    @define-color red_2 #${base0E};
    @define-color red_3 #${base0E};
    @define-color red_4 #${base0E};
    @define-color red_5 #${base0E};
    @define-color purple_1 #${base09};
    @define-color purple_2 #${base09};
    @define-color purple_3 #${base09};
    @define-color purple_4 #${base09};
    @define-color purple_5 #${base09};
