...
pkgs.stdenv.mkDerivation (finalAttrs: rec {
  ...
  desktopItem = pkgs.makeDesktopItem rec {
    ...
    categories = [ "Utility" ];
    icon = pkgs.fetchurl {
      url = "https://raw.githubusercontent.com/barry-allen07/FB-Mod/refs/tags/4.8.5/installer/icons/filebot.svg";
      hash = "sha256-gPwPjYJDk6Lpe1cG/MT3c3x2HNKWvheUYIkESY7sTKs=";
    };
  };
